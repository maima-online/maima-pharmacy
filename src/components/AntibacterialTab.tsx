...
import AntibacterialDrugCard from "./AntibacterialDrugCard";
...
export default function AntibacterialTab() {
      ...
      <TabPanel value={value} index={0}>
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibacterialDrugCard card={card1} />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibacterialDrugCard card={card2} />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibacterialDrugCard card={card3} />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibacterialDrugCard card={card4} />
          </Grid>
        </Grid>
      </TabPanel>
