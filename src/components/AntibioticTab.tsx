...
import AntibioticDrugCard from "./AntibioticDrugCard";
...
const AntTab = styled((props: StyledTabProps) => (
  ...
  "&.Mui-selected": {
    color: "#568089",
    fontWeight: 600,
    borderBottom: "1px solid #568089",
  },
  "&.Mui-focusVisible": {
    backgroundColor: "#568089",
  },
}));
      ...
      <TabPanel value={value} index={0}>
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibioticDrugCard card={card1} />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibioticDrugCard card={card2} />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibioticDrugCard card={card3} />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3} xl={3}>
            <AntibioticDrugCard card={card4} />
          </Grid>
        </Grid>
      </TabPanel>
